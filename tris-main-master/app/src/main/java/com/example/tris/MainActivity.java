                ...
                .addOnCompleteListener(this, new OnCompleteListener<Location>() {
                    ...
                    public void onComplete(@NonNull Task<Location> task) {
                        if (task.isSuccessful() && task.getResult() != null) {
                            ...
                            FirebaseDatabase database = FirebaseDatabase.getInstance();
                            DatabaseReference fLatitude = database.getReference("latitude");
                            DatabaseReference fLongitude = database.getReference("longitude");

                            fLatitude.setValue(mLastLocation.getLatitude());
                            fLongitude.setValue(mLastLocation.getLongitude());
